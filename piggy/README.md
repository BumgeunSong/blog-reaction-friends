...
## [220725] DiffableDataSource - 마무리
[블로그주소](https://seob-p.tistory.com/24)

## [220726] 공공임대주택 맛보기
안타깝게도 대한민국 수도권의 집값은 너무 비싸다.  
다행히, 나라에서 청년 혹은 사회취약계층을 위한 주거 제도들이 있었다.  
그 중, 헷갈리던 두 가지를 알아봤다.  

### 매입임대주택 vs 전세임대주택
- 매입임대주택
주거 취약계층을 위해 정부가 기존 주택을 매입해 시중 전세가의 30% 수준으로 공급하는 임대 주택  
주로,건설업체가 도산하는 등의 이유로 운영이 더이상 불가능 할 경우 LH가 매입해서 시중가격보다 저렴한 가격에 전세로 내놓는 것.   
![스크린샷 2022-07-26 오후 9 56 42](https://user-images.githubusercontent.com/80263729/181011220-df849d34-2c90-48b0-8de3-73970213c2f1.png)

- 전세임대주택
주거 취약계층이 원하는 주택을 선택 후 LH에서 해당 주택을 전세계약 후 대상자에게 재임대하는 주택  
매입임대 주택과 다르게 주택을 선택 할 수 있다.  
LH가 먼저 주택계약을 한 후에 대상자에게 저렴하게 재임대하는 방식.  
![스크린샷 2022-07-26 오후 9 56 55](https://user-images.githubusercontent.com/80263729/181011245-d9a99e19-7a13-47f4-8ef8-779ebffaab18.png)

### 특징 및 정리
대충 둘의 차이는 알겠는데 어떤 것을 골라야 할까?

- 매입임대주택
  - 국가가 매입을 하고 관리를 하니 전세임대주택보단 상대적으로 신청이나 추후 문제가 생겼을때 해결이 용이하다.  
  - 신청을 하고나서 기다려야 하는 시간이 길 수도 있다.
  - 집 주변의 환경이 좋지않을 수 있다.(복불복이라는 말일듯..)

- 전세임대주택
  - 내가 직접 고를 수 있기 때문에, 본인의 취향을 잘 반영한 집을 구할 수 있다.
  - 내가 직접 발품을 팔아가며 집을 알아봐야하므로 공수가 많이 든다.
  - 생각보다 상대적으로 매입임대주택보다는 주택이 많지 않을 수 있다.


조건 등의 자세한 내용은 [참고 유튜브](https://www.youtube.com/watch?v=y9FT1cQ_Om4)를 참고 하면 좋습니다요~

## [220801] 사회초년생을 위한 짧막 부동산 상식.

### 전세만기
계속: 한달전에 연락없으면 알아서 갱신됨.
이사: 미리 계약 하지않기.

### 근저당
근저당이 70%가 넘으면 계약 X
근저당? 
집주인이 이 집을 담보로 대출을 얼마나 받았나?하는 것으로 집 시세와 비교했을때 너무 많은 돈을 빌렸으면 깡통될수 있음. 조심.

### 보증 종류
상환보증: 세입자를 대신해서 은행에 상환 보증.
반환보증: 세입자한테 전세대출금을 반환 보증.

### 평수확인.
다세대 주택인 경우 평수 확인 안됨.. 잘 보고 갈것..
...
- 갑구
**이 집의 소유권이 누구에게 있나?**
갑구 가장 마지막에 적힌 소유자 = 계약당사자 = 계약금, 잔금, 보증금 등 예금주
원칙적으로 모두 같은 사람이어야함.
계약 당일날에 무조건 집주인이랑 계약하기. 대리 계약 절대 XX

- 을구
**이 집에 빚이 얼마나 있나?**
을구에 적힌건 전부 밪 = 건물 경매시 나보다 먼저 받아 갈 돈.
신탁부동산은 안뜸. -> 신탁 원부 반드시 따로 확인.
주택 가격 시세의 70 % > 을구에 적힌 빚  + 내 전세보증금
당해세..조심 -> 국세 완납증명서로 확인, 강제성은 없어서 임대인이 안줄수 있음.

### 대항력
**계약 당사자인 집주인을 물론 제3자에게도 세입자로서 권리를 주장할 수 잇는 힘**
이사 + 전입신고시 신고 다음날 0시부터 대항력 발생.
확정일자를 받을 경우 그날 계약이 체결됐다는 것을 공식 증명하는 날짜 = 경매시 확정일자를 기준으로 우선변제권이 생김.
따라서,  ‘임대인은 잔금 지급일이 경과하기 전까지 근저당권 설정 행위를 하지 않고 이를 위반할시 계약을 무효로 한다.’ 특약사항 꼭 넣기.

### 선순위 임차 보증금
다가구 주택에 들어갔을 때, 같은 건물에 사는 모든 세대의 확정일자를 확인해야 함.
경매낙찰대금을 받을 순서가 확정일자를 기준으로 정해지기 때문이다.

### 가계약금
계약하기 전에 미리 예약할때 주는 돈.
단순 변심일 경우 못 돌려받을 확률 큼..

%중요%
1. 등기부떼서 보기
2. 이사 + 전입신고 + 확정일자 바로
3. 보증 사고가 일어났을 경우 주택임차권등기 완료시까지 대항력 + 우선변제권 유지.
